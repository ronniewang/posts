...
public class Keys {
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<Record, Record> FK_BOOK_AUTHOR = createForeignKey(Keys.CONSTRAINT_7, Book.BOOK, "FK_BOOK_AUTHOR", Book.BOOK.AUTHOR_ID);
        public static final ForeignKey<Record, Record> FK_BOOK_LANGUAGE = createForeignKey(Keys.CONSTRAINT_C, Book.BOOK, "FK_BOOK_LANGUAGE", Book.BOOK.LANGUAGE_ID);
        public static final ForeignKey<Record, Record> FK_B2BS_BOOK_STORE = createForeignKey(Keys.CONSTRAINT_F, BookToBookStore.BOOK_TO_BOOK_STORE, "FK_B2BS_BOOK_STORE", BookToBookStore.BOOK_TO_BOOK_STORE.NAME);
